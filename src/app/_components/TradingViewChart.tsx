...
const TradingViewChart: React.FC<TradingViewChartProps> = ({ selectedPair }) => {
    ...
    script.onload = () => {
      ...
      if (tvWindow.TradingView) {
        ...
        new tvWindow.TradingView.widget({
          ...
          width: "100%",
          height: 500,
          symbol: selectedPair, // ✅ Use the passed prop here
          interval: "D",
          timezone: "Etc/UTC",
  ...
  }, [theme, selectedPair]); // ✅ Re-run effect when selectedPair changes

  return (
    <>
      {isLoading &&

        <div className="absolute h-dvh overflow-clip w-screen top-0 left-0 bg-background z-50 flex justify-center items-center">
      ...
      <div id="tradingview-widget" ref={containerRef} />
    </>
  );
};
